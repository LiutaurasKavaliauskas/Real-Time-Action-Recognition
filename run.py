...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def set_ui(self):
        ...
        self.setWindowTitle(u'REAL TIME ACTION RECOGNITION')
    ...
    def button_event(self):
        ...
        if sender == self.button_mode_1 and self.timer_camera.isActive():
            ...
            if self.timer_camera.isActive() == False:
                ...
                if flag == False:
                    msg = QtWidgets.QMessageBox.warning(self, u"Warning", u"PLEASE CHECK THE CAMERA",
                ...
                self.infoBox.setText(u'CAMERA CLOSED')
